...
export default function Products({ products: unFillteredProducts }) {
  ...
  const priceRanges = [5000, 15000, 30000, 40000, 500000];
  ...
  useEffect(() => {
    if (state) {
      setFilterlist(
        products.filter((product) => product.category === state._id)
      );
    }
  }, [state]);
            ...
            <div className="products__filter__card__container__wraper__entry">
              ...
              >
                ...
                <g>
                  ...
                  <path
                    id="uuid-da16df1e-5659-4232-96f6-61e8c639a9ec-93"
                  ...
                  <g>
                    <path
                      id="uuid-6bf35aa9-e432-4b51-af77-8f4eb19e6e42-94"
